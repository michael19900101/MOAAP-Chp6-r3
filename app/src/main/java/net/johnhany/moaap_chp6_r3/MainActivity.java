...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String FILE_LOCATION = Environment.getExternalStorageDirectory() + "/photos/";

    static int REQUEST_WRITE_EXTERNAL_STORAGE = 10;
    static int REQUEST_READ_EXTERNAL_STORAGE = 11;
    static int REQUEST_TAKE_PHOTO = 12;
    static boolean write_external_storage_granted = false;
    static boolean read_external_storage_granted = false;
    static boolean take_photo_granted = false;
        ...
        bClickImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    fileUri = FileProvider.getUriForFile(MainActivity.this, "net.johnhany.moaap_chp6_r3.fileprovider", image);
                } else {
    ...
    private void requestPermissions(){
        ...
        if (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.CAMERA)
                != PackageManager.PERMISSION_GRANTED) {
            Log.i("permission", "request REQUEST_TAKE_PHOTO");
            ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.CAMERA}, REQUEST_TAKE_PHOTO );
        }else {
            Log.i("permission", "REQUEST_TAKE_PHOTO already granted");
            take_photo_granted = true;
        }

        if (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            Log.i("permission", "request REQUEST_WRITE_EXTERNAL_STORAGE");
            ...
            Log.i("permission", "REQUEST_WRITE_EXTERNAL_STORAGE already granted");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String permissions[], @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                // permission was granted
                Log.i("permission", "REQUEST_TAKE_PHOTO granted");
                take_photo_granted = true;
            } else {
                // permission denied
                Log.i("permission", "REQUEST_TAKE_PHOTO denied");
            }
        }
        if (requestCode == REQUEST_WRITE_EXTERNAL_STORAGE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                // permission was granted
                Log.i("permission", "REQUEST_WRITE_EXTERNAL_STORAGE granted");
                write_external_storage_granted = true;
            } else {
                // permission denied
                Log.i("permission", "REQUEST_WRITE_EXTERNAL_STORAGE denied");
            }
        }
    }
    ...
    private void createPanorama(){
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                dialog = ProgressDialog.show(MainActivity.this, "正在合成全景照片", "请稍后");
            }
